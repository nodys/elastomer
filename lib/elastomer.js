...
Elastomer.prototype._extractIdMap = function (root) {
  var idMap = {}
  utils.toArray(root.querySelectorAll('*[id]'))
...
Elastomer.prototype._bind = function (node) {
  ...
  this['$'] = this._extractIdMap(this.shadowRoot)
...
Elastomer.prototype.on = function (obj, eventName, handler) {
  ...
  if (obj.addEventListener) {
    ...
    res = obj.attachEvent('on' + eventName, handler)
  } else if (obj.on) {
...
Elastomer.prototype.once = function (obj, eventName, handler) {
  var self = this
  function wrap () {
    self.off(obj, eventName, wrap)
    return handler.apply(this, arguments)
  }
  return self.on(obj, eventName, wrap)
}
...
Elastomer.prototype['$$'] = function (selector) {
