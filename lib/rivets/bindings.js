...
export class Binding extends BindingAbstract {
  constructor (view, el, type, keypath, options = {}) {
    super()
    this.view = view
    this.el = el
...
export class ComponentBinding extends BindingAbstract {
...
export class TextBinding extends BindingAbstract {
