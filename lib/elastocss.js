...
module.exports = function (elementName, css, useNative) {
  if (!map[elementName]) {
    map[elementName] = new ElastoCss(elementName, css, useNative)
  }
}

function ElastoCss (elementName, css, useNative) {
  var self = this
  self.elementName = elementName
  self.css = css
  self.useNative = Boolean(useNative)
