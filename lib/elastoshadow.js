...
ElastoShadow.prototype._setInnerHTML = function (html) {
  ...
  // TODO: Not efficient : each node is created twice !!
  // we may create the shadow directly into the host, then
  // move nodes from lightdom to the distribution nodes.
  // And let ignore this step if the host is empty !
  //
  ...
  // TODO: Create cached version of the html with css scope allready defined?
  if (elasto.css) {
